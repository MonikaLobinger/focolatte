...
class Nav {
	...
	build(data = null) {
      ...
      if(sub) {
			r += `<li class="has-child">`;
			r += `<details class="side-element">`;
			r += `<summary class="side-element-title">`;
			r +=   `<a href="${ref.url}" tabindex="-1">${this.wbr ? $.wbr(ref.text) : ref.text}</a>`;
			r += `</summary>`;
			r +=   sub;
			r += `</details>`;
			r += `</li>`;
			...
			r += `<li>`;
			r += `<div class="side-element">`;
			r += `<div class="side-element-title">`;
			r +=   `<a href="${ref.url}">${this.wbr ? $.wbr(ref.text) : ref.text}</a>`;
			r += `</div>`;
			r += `</div>`;
			r += `</li>`;
      }
